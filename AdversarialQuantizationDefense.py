...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 20 21:39:51 2020
...
mean_cat_defense,cov_cat_defense, pi_cat_defense = mean_cov(q1.forward(augmented_cat),q1.forward(augmented_grass))
mean_grass_defense,cov_grass_defense, pi_grass_defense = mean_cov(q1.forward(augmented_grass),q1.forward(augmented_cat))
...
if args.attack_type.lower() == 'whitebox':
    ...
    display_image(img_perturbed = Y, 
                  ...
                  stride=args.stride,
                  path="./Outputs/Defense/AdversarialQuantize/"+args.train+'/'+str(args.n_bits)+'bit/'+args.attack_type+'/',
                  infer=True) 
else:
    raise ValueError
